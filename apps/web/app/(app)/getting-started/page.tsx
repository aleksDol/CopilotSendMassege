...
const startSteps = [
  {
    ...
    description: "Подключите свой рабочий Telegram-аккаунт, чтобы видеть все диалоги в системе."
  },
  {
    title: "Заполните базу знаний",
    description: "Добавьте информацию о компании, цены, FAQ и условия работы. Это нужно, чтобы AI давал точные ответы."
  },
  {
  ...
  },
  {
    ...
    description: "Система предложит, что можно ответить клиенту: отправить как есть, отредактировать или сгенерировать другой вариант."
  },
  {
    title: "Следите за задачами",
    description: "Система подскажет, где вы не ответили и где нужно сделать follow-up."
  }
];
...
const featureCards = [
  {
    title: "Чаты",
    description: "Все личные диалоги в одном месте. Больше не нужно переключаться между окнами.",
    icon: MessageCircle
  },
  {
    title: "AI-помощник",
    description: "Подсказывает, что написать клиенту: отвечает на вопросы, помогает продавать и учитывает контекст диалога.",
    icon: Bot
  },
  {
    title: "Задачи",
    description: "Система отслеживает, кому вы не ответили, где клиент «завис» и где нужно написать повторно.",
    icon: CheckSquare
  },
  {
    title: "Дашборд",
    description: "Общая картина: сколько диалогов, сколько требуют ответа и какая активность сейчас в работе.",
    icon: ChartColumn
  },
  {
    title: "База знаний",
    description: "Хранит FAQ, цены, правила и описание продукта. AI использует эти данные для ответов.",
    icon: BookOpen
  },
  {
    title: "Политика ответов",
    description: "Вы задаёте стиль общения, ограничения и правила, чтобы AI отвечал так, как нужно вам.",
    icon: ShieldCheck
  }
];
