...
- сделай короткое интро: 1 фраза \"что делаем\" + 1 фраза \"главный плюс\" (оба из AI Brain, без хардкора)
- затем 1 квалифицирующий вопрос (например с 2 вариантами ответа)
...
- слишком общие заходы: "у нас есть взаимный пиар", "у нас есть сервис" без конкретной 1 ценности/механики
